        ...
        <>
            <div className="container-xl">
                ...
                >
                    ...
                    <div className={`col-lg-7 text-center ${style.mediaInText_section3_min}`}>
                            <p className={` fs-6 fw-bold mt-2`}>
                                Effortless Validation for
                            </p>
                            <h2 className={` fs-3 fw-bold mt-1`}>
                                Management
                            </h2>
                            <p
                                className={`  fw-normal mt-4 ${style.section_3_text}`}
                            >
                            ...
                            <h4 className={` fs-6 fw-bold mt-2`}>
                                Accessory makers
                            </h4>
                            <p
