...
import { WiDaySunny, WiSolarEclipse } from "react-icons/wi";
import { useTranslation } from "react-i18next";
import { setLocale } from "../../../translations";
import userdefaultavatar from "../../../public/Image/defaultimagesellerbuyer.png";
...
export default function Header() {
    ...
    const onClick = useCallback(
        (evt) => {
            ...
            if (isDarkMode) {
                styles = `  background-color:#f6f6f6 !important;                          
            ...
            <div className={style.headers}>
                <nav className={`navbar navbar-expand-lg navbar-light `}>
                    <div className={`container`}>
                        {accessToken ? (
                            <Link href={"/UserProfilebuyer/UserProfile"}>
                                <a
                        ...
                        >
                            ...
                            {accessToken ? (
                                <div class="dropdown">
                                    <button
                                        className={`${style.avatardefbutton} btn btn-secondary dropdown-toggle`}
                                        type="button"
                                    ...
                                    <label
                                        data-bs-toggle="dropdown"
                                        htmlFor="dropdownMenuButton1"
                                        className={style.useravpos}
                                    >
                                        <Image
                                    ...
                                    <ul
                                        className={`${style.dropmenusett} dropdown-menu`}
                                        aria-labelledby="dropdownMenuButton1"
                                    >
                                        <li>
                                            <Link href="/Infopageusers/Infopageusers">
                                ...
                                <>
                                    ...
                                    <Link href={"/Registration"}>
                                        <a
                                            className={`btn text-white h-6   ${style.Sign_Up_btn}`}
                                        >
                                            {t("register")}
                                        </a>
                                    </Link>
