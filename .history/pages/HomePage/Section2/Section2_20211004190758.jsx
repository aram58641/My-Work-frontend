            ...
            <div className={style.big_section_2_box}>
                <div className="container-xl">
                  ...
                  {product.map((prodItem)=>{
                       return (
                       <div key={prodItem.id + "-section2"} className={`col-sm-2 mt-5 bg-white text-left ${style.Section2_boxes}`}>

                            <h2 className={`mt-1`}>{prodItem.title}</h2>
                            <p className={`mt-1`}>{prodItem.text}</p>
