                ...
                <div className="container-xl">
                    ...
                    <div className="row d-flex justify-content-around">
                        <div className="col-sm-3 d-flex align-items-center ">
                            <Image src={Avtoravatar1} className={`mr-3 img-fluid`} />
                            <span className={style.avatar_setting}>I can take care of your pitch</span>
                        </div>

                        <div className="col-sm-3 d-flex align-items-center">
                            <Image src={Avtoravatar2} className={`mr-3 img-fluid`} />
                            <span className={style.avatar_setting}>I can prototype your app</span>
                        </div>
                    </div>
                </div>
            </div>
