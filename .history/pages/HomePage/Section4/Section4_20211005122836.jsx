    ...
    return (
        <>
            <div className="container-xl">
                <div className={`d-flex align-items-center ${style.big_section_4_box}`}>
                    
                <div className="row">
                        <div className="col-lg-7">
                            <p className={`text-right fs-6 fw-bold mt-2`}>
                                Effortless Validation for
                            </p>
                            <h2 className={`text-right fs-3 fw-bold mt-1`}>
                                Management
                            </h2>
                            <p
                                className={`text-right  fw-normal mt-4 ${style.section_3_text}`}
                            >
                            ...
                            <h4 className={`text-right fs-6 fw-bold mt-2`}>
                                Accessory makers
                            </h4>
                            <p
                                className={`text-right  fw-normal mt-4 ${style.section_3_text}`}
