    ...
    return (
        <>
            <div className="container-xl">
                ...
                >
                    <div className={`row d-flex justify-content-end ${style.mediaInText_section5}`}>
                        <div className={`col-lg-5 ${style.mediaInText_section5_min}`}>
                            ...
                            <p
                                className={`text-end  fw-normal mt-4 ${style.section_5_text}`}
                            >
