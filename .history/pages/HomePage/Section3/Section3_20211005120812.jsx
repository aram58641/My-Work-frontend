                ...
                <div className={`d-flex align-items-center ${style.big_section_3_box}`}>
                    <div className="row">
                        <div className="col-lg-7">
                            <p className={`text-left fs-6 fw-bold mt-2`}>Effortless Validation for</p>
                            <h2 className={`text-left fs-3 fw-bold mt-1`}>Management</h2>
                            <p className={`text-left  fw-normal mt-4 ${style.section_3_text}`}>
                            ...
                            <h4 className={`text-left fs-6 fw-bold mt-2`}>Accessory makers</h4>
                            <p className={`text-left  fw-normal mt-4 ${style.section_3_text}`}>
                                While most people enjoy casino gambling, sports
                                betting, lottery and bingo playing for the fun
                            </p>
                            <h4 className={`text-left fs-6 fw-bold mt-2`}>Alterationists</h4>
                            <p className={`text-left  fw-normal mt-4 ${style.section_3_text}`}>
