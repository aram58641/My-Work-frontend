...
export default function Section7() {
    ...
    const [work, SetWork] = useState([
        ...
        },
        {
            ...
            text: "The Myspace page defines the individual. most people enjoy",
        },
            ...
            <div className={` ${style.big_section_7_box}`}>
                <div className="container-xl">
                    ...
                    <div className="row mt-5">
                        <div className="col-md-12 text-left text-dark mt-5">
                            <h2 className="fs-3 fw-bold ">Contents Strategies</h2>
                        </div>
                    </div>
                    <div className="row mt-3">
                        <div className="col-md-12 text-dark text-left ">
                ...
                {work.map((workItem) => {
                            return (
                                <div
                                    ...
                                    className={`text-dark col-lg-3 mt-5 bg-white text-center ${style.Section2_boxes}`}
                                >
                                    <Image
