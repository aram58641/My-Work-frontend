...
export default function Header() {
    ...
    const onClick = useCallback(
        (evt) => {
            ...
            if (isDarkMode) {
                document.body.style.remove("background-color:red !important;");
                document.body.style.add("background-color:red !important;");
                setIsDarkMode(false);
            } else {
                document.body.style.remove("theme-light");
                document.body.style.add("theme-dark");
                setIsDarkMode(true);
            }
            // document.body.style = `
