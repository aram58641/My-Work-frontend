        ...
        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          ...
          <li>
            ...
            <ul class="dropdown-menu dropdown-submenu">
              ...
              <li>
                <a ="dropdown-item" href="#">Submenu item 3 &raquo; </a>
                <ul ="dropdown-menu dropdown-submenu">
                  <li>
                    <a ="dropdown-item" href="#">Multi level 1</a>
                  </li>
                  <li>
                    <a ="dropdown-item" href="#">Multi level 2</a>
                  </li>
                </ul>
              </li>
              <li>
                <a ="dropdown-item" href="#">Submenu item 4</a>
              </li>
              <li>
                <a ="dropdown-item" href="#">Submenu item 5</a>
              </li>
            </ul>
          </li>
        </ul>
