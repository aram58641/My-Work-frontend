                ...
                <div class="row g-2 ">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="product-detail-container">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="mb-0">Black top caps</h6>{" "}
                                    <span class="text-danger font-weight-bold">
                                        $1.99
                                    </span>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="product-detail-container">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="mb-0">Kiton sui suit</h6>{" "}
                                    <span class="text-danger font-weight-bold">
                                        $3.99
                                    </span>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="product-detail-container">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="mb-0">Long red shirt</h6>{" "}
                                    <span class="text-danger font-weight-bold">
                                        $4.99
                                    </span>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="product-detail-container">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="mb-0">Long black t-shirt</h6>{" "}
                                    <span class="text-danger font-weight-bold">
                                        $3.99
                                    </span>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="product-detail-container">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="mb-0">TINONG white specs</h6>{" "}
                                    <span class="text-danger font-weight-bold">
                                        $3.99
                                    </span>
                                </div>
