...
import Jsonpage from "../../../../../Json/Menu.json";
        ...
        <>
            <div className="container-xl mt-5 mb-5">
                <div className="row g-2">
                    {/*Filter */}
                    <h1 className = {`text-center text-secondary`}>{router.query.cat.name}</h1>
                    ...
                    {/* Products */}
                        ...
                        <Categori productfilter={JsonProduct} productp={Jsonpage} />
                </div>
            </div>
        </>
    );
