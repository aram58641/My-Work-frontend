...
export default function Header() {
    ...
    const onClick = useCallback(
        (evt) => {
            ...
            if (isDarkMode) {
                document.body.style =   `background-color:#2e2e2e;`;
                document.body.style =   `background-color:white;`;
                setIsDarkMode(false);
            } else {
                document.body.style =   `background-color:white;`;
                document.body.style =   `background-color:#2e2e2e; color:white !important;`;
                setIsDarkMode(true);
            }
        },
        [isDarkMode]
    ...
    return (
        ...
        <nav className={`navbar navbar-expand-lg navbar-light bg-white ${style.header}`}>
