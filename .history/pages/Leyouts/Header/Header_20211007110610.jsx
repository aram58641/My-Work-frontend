  ...
  <div class="container-fluid">
    <ul class="navbar-nav">
      <li class="nav-item dropdown">
        ...
        <ul C="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <li>
            <a C="dropdown-item" href="#">Action</a>
          </li>
          <li>
            <a C="dropdown-item" href="#">Another action</a>
          </li>
          <li>
            <a C="dropdown-item" href="#">
              Submenu &raquo;
            </a>
            <ul C="dropdown-menu dropdown-submenu">
              <li>
                <a C="dropdown-item" href="#">Submenu item 1</a>
              </li>
              <li>
                <a C="dropdown-item" href="#">Submenu item 2</a>
              </li>
              <li>
