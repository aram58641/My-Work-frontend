    ...
    return (
        <>
            <div className={style.headers}>
                ...
                <li className={ `dropdown-submenu ${style.dropdown-submenu}`}><a class="dropdown-item dropdown-toggle" data-toggle="dropdown" href="#">Something else here</a>
                    <ul className={ `dropdown-menu ${style.dropdown-menu}`} >
                        <a className={ `dropdown-item ${style.dropdown-item}`} href="#">A</a>
                        <a className={ `dropdown-item ${style.dropdown-item}`} href="#">b</a>
                    </ul>
                </li>
