                ...
                <div className="row g-2">
                    <div className={`col-md-3 ${style.backgrount_filter}`}>
                        ...
                        <input
                            ...
                            aria-label="Search"
                        />
                        <button className={`btn btn-outline-success ${style.search_button_header}`} type="submit">
                            Search
                        </button>
                    </form>
                        ...
                        <div className="row g-2">
                            <div className="col-md-4">
                                <div className= {`${style.product} py-4`} >
                                    {" "}
                                    <span className={`${style.off}  bg-success`}>
                                        -25% OFF
                                    </span>
                                    ...
                                    <div className={`${style.cartButton} mt-3 px-2 d-flex justify-content-between align-items-center`} >
                                        {" "}
                                    ...
                                    <div className= {`${style.cartButton}  mt-3 px-2 d-flex justify-content-between align-items-center`}>
                                        ...
                                        <div className="add">
                                            ...
                                            <span className= {`${style.product_fav}`}>
                                                ...
                                                <FaBeer className="fas fa-handshake"></FaBeer>
                                            </span>{" "}
                                            <span className= {`${style.product_fav}`}>
                                                <FaBeer className="fa fa-opencart"></FaBeer>
                                            </span>{" "}
                                ...
                                <div className="product py-4">
                                    ...
                                    <div className= {`${style.cartButton}  mt-3 px-2 d-flex justify-content-between align-items-center`}>
                                        ...
                                        <div className="add">
                                            {" "}
                                            <span className= {`${style.product_fav}`}>
                                                <FaBeer className="fa fa-heart-o"></FaBeer>
                                            </span>{" "}
                                            <span className= {`${style.product_fav}`}>
                                                <FaBeer className="fa fa-opencart"></FaBeer>
                                            </span>{" "}
