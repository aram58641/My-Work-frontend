...
import { FcCallback,FcKey,FcLandscape } from "react-icons/fc";
    ...
    return (
        <>
            <Main>
                ...
                <div className="container">
                    <div className={`${style.jumbo} jumbotron jumbotron-sm`}>
                        <div className="row">
                            <div className="col-sm-12 col-lg-12">
                                <h1 className={`${style.h2}`}>İletişim</h1>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        <div className="col-sm-6">
                            <div className="well">
                                ...
                                <p className={style.p1}>İzmit/KOCAELİ</p>
                                <br />
                                <br />
                                <h3 className={style.h33}>
                                    <FcKey
                                ...
                                <p className={style.p1}>info@birisi.com</p>
                                <br />
                                <br />
                                <h3 className={style.h33}>
                                    <FcLandscape
                                ...
                                <p className={style.p1}>Sorumlu Kişi</p>
                                <br />
                                <br />
                                <h3 className={style.h33}>
                                    <FcCallback
